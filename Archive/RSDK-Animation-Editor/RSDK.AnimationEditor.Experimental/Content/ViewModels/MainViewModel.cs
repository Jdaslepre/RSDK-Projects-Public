...
namespace RSDK.AnimationEditor.Experimental.Content.ViewModels
{
    public class MainViewModel : Xe.Tools.Wpf.BaseNotifyPropertyChanged
    {
        ...
        */
        ...
        public string TitleString => string.IsNullOrEmpty(FileName) ? "New tab" : $"{Path.GetFileName(FileName)} - Engineversion"; //"RSDK Animation Editor" : $"{Path.GetFileName(FileName)} - RSDK Animation Editor";
        public string FileNameString => Path.GetFileName(FileName);
        ...
        public IAnimation AnimationData
        {
            ...
            set
            {
                ...
                isHitboxVX = _animationData.HitboxTypes == null;
                IsHitboxV5 = !isHitboxVX;
                ...
                if (isHitboxVX)
                {
                    ...
                    //TitleString = $"{Path.GetFileName(FileName)} - RSDKv4";
                }
                else if (IsHitboxV5)
                {
                    HitboxTypes = new ObservableCollection<string>(_animationData.HitboxTypes);
                    //TitleString = $"{Path.GetFileName(FileName)} - RSDKv5";
                }
        ...
        private double _viewWidth, _viewHeight, _zoom = 3.0;
        ...
        public double Zoom
        {
            ...
            set
            {
                ...
                OnPropertyChanged();
                OnPropertyChanged(nameof(ZoomString));
                InvalidateCanvas();
            }
        }

        public string ZoomString => $"Zoom {Zoom.ToString("F2")}";
        ...
        #region Hitbox v3
        private bool _isHitboxVX;
        public bool isHitboxVX
        {
            get => _isHitboxVX;
            set
            {
        ...
        public bool IsNotHitboxVX => !isHitboxVX;
        public Visibility HitboxVXVisibility => isHitboxVX ? Visibility.Visible : Visibility.Collapsed;
        ...
        {
            OnPropertyChanged(nameof(isHitboxVX));
            OnPropertyChanged(nameof(IsNotHitboxVX));
            OnPropertyChanged(nameof(HitboxVXVisibility));
            OnPropertyChanged(nameof(HitboxEntries));
            OnPropertyChanged(nameof(HitboxItems));
