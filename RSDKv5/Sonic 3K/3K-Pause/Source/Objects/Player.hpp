...
struct Player : RSDK::GameObject::Entity {
    ...
    struct RSDKPathTracer {
        ...
        uint8 field_36;
        uint8 field_37;
        RSDK::GameObject::Entity *lastRightBoxCollision;
        RSDK::GameObject::Entity *lastLeftBoxCollision;
        RSDK::GameObject::Entity *lastBottomBoxCollision;
        RSDK::GameObject::Entity *lastTopBoxCollision;
        uint8 field_58;
        uint8 field_59;
        uint8 field_5A;
        uint8 field_5B;
    ...
    struct Static : RSDK::GameObject::Static {
        ...
        RSDK::SoundFX sfxUnused[4]; // Maybe
        RSDK::SoundFX sfxEarthquake;
#if ORIGINS_USE_PLUS
        RSDK::SoundFX sfxHammerJump;
        RSDK::SoundFX sfxHammerDash;
        RSDK::SoundFX sfxHammerHit;
#endif
        int32 unknown1290;
    ...
    static RSDK::Action<void> State_Victory;
