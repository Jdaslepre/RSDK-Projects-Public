...
void TitleSeq::CheckTouchCheatCodes(void) {
    ...
    if (!modSVars->touchDown) {
        ...
        if (Touch::CheckRect(pos, 90, len, 160, nullptr, nullptr) >= 0) {
...
bool32 TitleSeq_State_WaitSEGA_Hook(bool32 skippedState) {
    ...
    touched |= Touch::CheckRect(0, 0, screenInfo->center.x - 90, screenInfo->size.y, nullptr, nullptr) >= 0;
    touched |= Touch::CheckRect(screenInfo->center.x + 91, 0, screenInfo->size.x, screenInfo->size.y, nullptr, nullptr) >= 0;
    touched |= Touch::CheckRect(screenInfo->center.x - 90, 0, screenInfo->center.x + 91, 88, nullptr, nullptr) >= 0;
    touched |= Touch::CheckRect(screenInfo->center.x - 90, 152, screenInfo->center.x + 91, screenInfo->size.y, nullptr, nullptr) >= 0;
