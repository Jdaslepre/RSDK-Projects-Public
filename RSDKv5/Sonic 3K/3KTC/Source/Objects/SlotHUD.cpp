...
{
    auto player = GameObject::Get<S1SS_Player>(sceneInfo->currentScreenID);
    ...
    auto player1 = GameObject::Get<S1SS_Player>(SLOT_PLAYER1);
...
void SlotHUD::DrawTouchControls(void)
{
    ...
    auto player    = GameObject::Get<S1SS_Player>(playerID);
