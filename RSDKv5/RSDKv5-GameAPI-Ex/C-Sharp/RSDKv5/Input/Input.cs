...
namespace RSDK
{
    ...
    {
#if RETRO_REV02
        public static uint GetInputDeviceID(byte controllerID) { return RSDKTable.GetInputDeviceID(controllerID); }
        public static uint GetFilteredInputDeviceID(uint confirmOnly, uint unassignedOnly, uint maxInactiveTimer) { return RSDKTable.GetFilteredInputDeviceID(confirmOnly, unassignedOnly, maxInactiveTimer); }
        public static int GetInputDeviceType(uint deviceID) { return RSDKTable.GetInputDeviceType(deviceID); }
        public static uint IsInputDeviceAssigned(uint deviceID) { return RSDKTable.IsInputDeviceAssigned(deviceID); }
        public static int GetInputDeviceUnknown(uint deviceID) { return RSDKTable.GetInputDeviceUnknown(deviceID); }
        public static int InputDeviceUnknown1(uint deviceID, int unknown1, int unknown2) { return RSDKTable.InputDeviceUnknown1(deviceID, unknown1, unknown2); }
        public static int InputDeviceUnknown2(uint deviceID, int unknown1, int unknown2) { return RSDKTable.InputDeviceUnknown2(deviceID, unknown1, unknown2); }
        public static int GetInputSlotUnknown(byte inputSlot) { return RSDKTable.GetInputSlotUnknown(inputSlot); }
        public static int InputSlotUnknown1(byte inputSlot, int unknown1, int unknown2) { return RSDKTable.InputSlotUnknown1(inputSlot, unknown1, unknown2); }
        public static int InputSlotUnknown2(byte inputSlot, int unknown1, int unknown2) { return RSDKTable.InputSlotUnknown2(inputSlot, unknown1, unknown2); }
        ...
        public static uint IsInputSlotAssigned(byte inputSlot) { return RSDKTable.IsInputSlotAssigned(inputSlot); }
