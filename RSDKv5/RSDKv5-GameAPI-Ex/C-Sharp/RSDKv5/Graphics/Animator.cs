...
namespace RSDK
{
    public unsafe struct Animator
    {
        ...
        public void SetAnimation(RSDK.SpriteAnimation spriteAni, ushort listID, uint force, int frameID)
        {
            fixed (RSDK.Animator* ani = &this) RSDKTable.SetSpriteAnimation(spriteAni.aniFrames, listID, ani, force, frameID);
        }
        public void SetAnimation(RSDK.SpriteAnimation* spriteAni, ushort listID, uint force, int frameID)
        {
...
#else
        public void SetAnimation(RSDK.SpriteAnimation spriteAni, ushort listID, uint force, ushort frameID)
        {
            fixed (RSDK.Animator* ani = &this) RSDKTable.SetSpriteAnimation(spriteAni.aniFrames, listID, a, force, frameID);
        }
        public void SetAnimation(SpriteAnimation* spriteAni, ushort listID, uint force, ushort frameID)
        {
            fixed (RSDK.Animator* ani = &this)
            {
        ...
        public void DrawSprite(RSDK.Vector2* drawPos, uint screen) { fixed (RSDK.Animator* ani = &this) RSDKTable.DrawSprite(ani, drawPos, screen); }
