...
[CRepr] public struct RSDKFunctionTable
{
	...
	public function void(uint8 sourceBank, uint8 srcBankStart, uint8 destinationBank, uint8 destBankStart, uint16 count) CopyPalette;
#if RETRO_REV02
	public function void(uint8 bankID, char8* path, uint16 disabledRows) LoadPalette;
#endif
	public function void(uint8 bankID, uint8 startIndex, uint8 endIndex, bool right) RotatePalette;
...
{
	public RSDK.RSDKFunctionTable* RSDKTable;
#if RETRO_REV02
	public RSDK.APIFunctionTable* APITable;
#endif

	public RSDK.GameInfo* gameInfo;
#if RETRO_REV02
	public RSDK.SKUInfo* currentSKU;
#endif
	public RSDK.SceneInfo* sceneInfo;

	public RSDK.ControllerState* controllerInfo;
	public RSDK.AnalogState* stickInfoL;
#if RETRO_REV02
	public RSDK.AnalogState* stickInfoR;
	public RSDK.TriggerState* triggerInfoL;
	public RSDK.TriggerState* triggerInfoR;
#endif
	public RSDK.TouchInfo* touchInfo;

#if RETRO_REV02
	public RSDK.UnknownInfo* unknownInfo;
#endif

	public RSDK.ScreenInfo* screenInfo;

#if RETRO_REV02 && RETRO_REV0U
	public void* hedgehogLink;
#endif

#if RETRO_USE_MOD_LOADER
	public RSDK.ModFunctionTable *modFunctionTable;
#endif
}
