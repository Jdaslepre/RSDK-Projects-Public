...
extern void (*UIControl_SetActiveMenu)(UIControl *entity);
extern UIControl *(*UIControl_GetUIControl)(void);
extern void (*UIControl_MatchMenuTag)(const char *text);
